...
marcadorsize   = int(bg.get_height()/150)
...
ind3txt       = indfont1.render("HORARIA",True,bgcolour)
...
while True :
	...
	# Marcadors Segons no passats
	shx = shy = 0
	while shx < 360:
		pygame.draw.circle(bg, clockcolour, (paraeqsmx(shx),paraeqsmy(shy)),marcadorsize)
